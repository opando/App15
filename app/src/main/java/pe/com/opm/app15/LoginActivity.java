...
public class LoginActivity extends AppCompatActivity {
    ...
    public static final String APP_PACKAGE = "pe.com.opm.app15";
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                GraphRequest gr = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        Log.v("GraphJSONO : " , response.toString());
                        ...
                        try {
                            ...
                            String publicProfile = object.getString("name");

                            //String userFriends = object.getString("user_friends");

                            Log.v("#### email",email);
                            //Log.v("##### userFriends",userFriends);
                ...
                */
                ...
                /*
                tvLogin.setText(" User ID : " + loginResult.getAccessToken().getUserId()
